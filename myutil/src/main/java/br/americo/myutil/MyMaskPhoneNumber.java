...
public class MyMaskPhoneNumber implements TextWatcher {
    ...
    private String formatUsNumber(Editable text) {
        ...
        if (totalDigitCount - alreadyPlacedDigitCount > 2) {
            formattedString.append("(").append(allDigitString.substring(alreadyPlacedDigitCount, alreadyPlacedDigitCount + 2)).append(") ");
        ...
        if (totalDigitCount - alreadyPlacedDigitCount > dashAfter) {
            formattedString.append(allDigitString.substring(alreadyPlacedDigitCount, alreadyPlacedDigitCount + dashAfter)).append("-");
